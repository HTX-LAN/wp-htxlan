...
// Databases for plugin
    ...
    function insert_data() {
        ...
        try {
            ...
            $tableId = 1; 
            $columnNameFront = "Fornavn"; $columnNameBack='firstName'; $format="string"; $columnType="inputbox"; $special=0; $specialName=""; $sorting = 1; $placeholderText = "John"; $adminOnly = 0;
            $stmt->execute();  
            $columnNameFront = "Efternavn"; $columnNameBack='lastName'; $format="string"; $columnType="inputbox"; $special=0; $specialName=""; $sorting = 2; $placeholderText = "Smith"; $adminOnly = 0;
            $stmt->execute();
            $columnNameFront = "E-mail"; $columnNameBack='email'; $format="string"; $columnType="inputbox"; $special=0; $specialName=""; $sorting = 3; $placeholderText = "john@htx-lan.dk"; $adminOnly = 0;
            $stmt->execute();
            ...
            $stmt->execute();
            $columnNameFront = "Billet type"; $columnNameBack='ticketType'; $format="string"; $columnType="dropdown"; $special=1; $specialName="price"; $sorting = 5; $placeholderText = ""; $adminOnly = 0;
            $stmt->execute();
            $columnNameFront = "Skole"; $columnNameBack='school'; $format="string"; $columnType="dropdown"; $special=0; $specialName=""; $sorting = 6; $placeholderText = ""; $adminOnly = 0;
            $stmt->execute();
            $columnNameFront = "Klasse"; $columnNameBack='class'; $format="string"; $columnType="dropdown"; $special=0; $specialName=""; $sorting = 7; $placeholderText = ""; $adminOnly = 0;
            $stmt->execute();
            $columnNameFront = "Discord navn"; $columnNameBack='discordTag'; $format="string"; $columnType="inputbox"; $special=0; $specialName=""; $sorting = 8; $placeholderText = "John#1234"; $adminOnly = 0;
            $stmt->execute();
            $columnNameFront = "Gametag one"; $columnNameBack='gametagOne'; $format="string"; $columnType="inputbox"; $special=0; $specialName=""; $sorting = 9; $placeholderText = "John"; $adminOnly = 0;
            $stmt->execute();
            $columnNameFront = "Betalt"; $columnNameBack='payed'; $format="number"; $columnType="inputbox"; $special=1; $specialName="payed"; $sorting = 10; $placeholderText = "0"; $adminOnly = 1;
            $stmt->execute();
            $stmt->close();
